...
<head>
  ...
  <!-- Fonts END -->
    ...
    <link href="<?php echo base_url()?>/application/assets/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="<?php echo base_url()?>/application/assets/css/animate.min.css" rel="stylesheet">
    <link href="<?php echo base_url()?>/application/assets/css/parsley.css" rel="stylesheet">
      <!--Fancy-box-->
  <link href="<?php echo base_url()?>/application/assets/plugins/fancybox/source/jquery.fancybox.css" rel="stylesheet">
    <!--fancy box-->
    <!--owl curcosel -->
